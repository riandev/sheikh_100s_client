...
const DownloadReport = () => {
  ...
  const handleReport = () => {
    fetch(`http://localhost:5011/getBRReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setBRReport(data));
    fetch(`http://localhost:5011/getTerritoryReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setTerritoyReport(data));
    fetch(`http://localhost:5011/getAreaReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setAreaReport(data));
    fetch(`http://localhost:5011/getRegionReport/${reportDate}`)
      .then((res) => res.json())
